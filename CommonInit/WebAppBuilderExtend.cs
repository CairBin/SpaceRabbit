...
{
    public static class WebAppBuilderExtend
    {
        public static void ConfigureDbConfiguration(this WebApplicationBuilder builder)
        {
            builder.Host.ConfigureAppConfiguration((hostCtx, configBuilder) =>
            {
                ...
                configBuilder.AddDbConfiguration(() => new MySqlConnector.MySqlConnection(connStr), reloadOnChange: true, reloadInterval: TimeSpan.FromSeconds(5));
            });
        }

        public static void ConfigureExtraServices(this WebApplicationBuilder builder, InitOptions initOptions)
        {
            ...
            services.Configure<JsonOptions>(options =>
            {
                ...
                options.JsonSerializerOptions.Converters.Add(new DateTimeConvert("yyyy-MM-dd HH:mm:ss"));
            });
